...
- **Given** the app composition root **When** `src/main.tsx` is scanned **Then** it mounts `AcceptableUse` in the app chrome. (Test: "AcceptableUse is linked from the app chrome".)

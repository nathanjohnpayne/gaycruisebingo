...
- **Given** the seeded pool **when** counted **then** it is the canonical 87-entry pool. (Test: "seeds the canonical 87-entry pool (w1-seed-and-composition)".)

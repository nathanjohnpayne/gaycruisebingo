...
This repository is **Gay Cruise Bingo**, a live multiplayer bingo PWA. It follows the AI Agent Tooling Standard defined in `ai_agent_tooling_standard.md` as a downstream **consumer** of the **mergepath** template — mergepath, not this repo, is the canonical template for projects in this GitHub account.
